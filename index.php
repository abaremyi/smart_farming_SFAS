<?php
/**
 * SFAS — Main Router (v3 — complete route map)
 * File: index.php
 */
...
$routes = [
    ...
    '/admin/profile-settings'             => 'modules/Authentication/views/profile.php',  // same page
...
function _serve404(string $path): void {
    ...
    height:100vh;margin:0;background:#f3fbf6;}
    .box{text-align:center}.box h1{font-size:5rem;font-weight:900;color:#1a5c2a;margin:0;}
    .box p{color:#64748b;margin:.5rem 0 1.5rem;}.box a{background:#2d9a4e;color:#fff;
    padding:.75rem 1.75rem;border-radius:99px;text-decoration:none;font-weight:700;}
    </style></head><body><div class="box"><h1>404</h1>
    <p>Page not found: <code>' . htmlspecialchars($path) . '</code></p>
    <a href="' . (defined('BASE_URL') ? BASE_URL : '/') . '/admin/dashboard">Dashboard</a>
    </div></body></html>';
}